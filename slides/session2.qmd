...
## Geometry types: the big seven {.smaller}

![The main simple feature geometry types. Source: [Pebesma & Bivand, 2023](https://r-spatial.org/book/)](https://r-spatial.org/book/03-Geometries_files/figure-html/fig-sfgeometries-1.png)
