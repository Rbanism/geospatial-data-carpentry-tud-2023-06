...
## First, let's get the data for this lesson

1. Download the data from **[https://edu.nl/qydvw](https://edu.nl/qydvw)**
2. Extract its content into the data folder of your RStudio project


## `sf` package for spatial vector data {.smaller}
...
- function names start with a prefix `st_` (spatial type), which is handy for auto-completion in RStudio
:::
...
![The main simple feature geometry types: the big seven. Source: [Pebesma & Bivand, 2023](https://r-spatial.org/book/)](https://r-spatial.org/book/03-Geometries_files/figure-html/fig-sfgeometries-1.png)

## `sf` package for spatial vector data {.smaller}

![Components of an sf object. Source: [Pebesma & Bivand, 2023](https://r-spatial.org/book/)](https://r-spatial.org/book/images/sf_obj.png)
