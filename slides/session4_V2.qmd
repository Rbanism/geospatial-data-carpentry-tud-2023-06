...
buildings$build_date <- as.numeric(if_else(as.numeric(buildings$start_date) <1900, 1900,as.numeric(buildings$start_date)))
...
Let's focus on really old building and imagine we're in charge of their conservation. We want to know **how much of the city would be affected by a non-construction zone of 100m around pre-1850 buildings**.
